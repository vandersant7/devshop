        ...
        <div className="container flex justify-between items-center gap-4">
                  ...
                  <div className="absolute z-[9999] hidden group-hover:block w-[200px] rounded-md bg-white shadow-md dark:bg-gray-900 p-2 text-black dark:text-white">
                    <ul className="space-y-2">
                      {DropdownLinks.map((data, index) => (
                        <li key={index}>
                          <a
                            className="text-gray-500 hover:text-black dark:hover:text-white duration-200 inline-block w-full to-sky-200 p-2 hover:bg-primary/20 rounded-md font-semibold"
                            href={data.link}>
                            {data.name}
                          </a>
                        </li>
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="relative group hidden sm:block">
              <input type="" placeholder="Search" className="search-bar" />
